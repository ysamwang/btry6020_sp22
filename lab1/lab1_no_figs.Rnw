...
## package which allows you to pull files directly from github
install.packages("readr")
library("readr")

fileName <- "https://raw.githubusercontent.com/ysamwang/btry6020_sp22/main/lab1/buffaloBills.csv"

# This pulls the data set into R, and assigns it to the variable `buffaloBills`
buffaloBills <- read.csv(url(fileName))
@
...
<<>>=
fileName <- "https://raw.githubusercontent.com/ysamwang/btry6020_sp22/main/lab1/FL.csv"

# This pulls the data set into R, and assigns it to the variable `buffaloBills`
florida <- read.csv(url(fileName))
